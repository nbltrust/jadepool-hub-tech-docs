**测试节点版本**：迭代测试release时使用的testnet节点版本。每次release更新。<br/>
**瑶池迭代版本**：对应上述“测试节点版本”的release版本。每次release更新。<br/>
**运维节点版本**：目前NBLtrust在运营的生产环境在使用的节点版本。该栏为空表示NBLtrust在运营的生产环境目前没有使用这条链。每次升级瑶池系统或节点时更新。<br/>
**瑶池生产版本**：目前NBLtrust在运营的生产环境在使用的瑶池版本，对应上述“运维节点版本”。该栏为空表示NBLtrust在运营的生产环境目前没有使用这条链。每次升级瑶池系统或节点时更新。<br/>
**维护状态**：“维护中”代表每次release前都会完全测试的链，“暂不维护”的区块链是目前没有客户系统在使用的链。<br/>

| BlockChain  | 测试节点版本(testnet)| 瑶池迭代版本 | 运维节点版本(mainnet) | 瑶池生产版本 | 维护状态 |
| ----------- | ---------- | ---------- | ---------- | ---------- | ---------- |
...
| EveriToken  | v4.1.0 | V0.13.17 |            |  | 暂不维护 |
