## ⚠️请参考最新版本文档
https://github.com/nbltrust/jadepool-hub-tech-docs/blob/master/Chinese/0.15.x%E7%91%B6%E6%B1%A0%E5%8D%95%E6%9C%BA%E9%83%A8%E7%BD%B2%E6%96%87%E6%A1%A3.md
...
* 具体文档可参考 https://nbltrust.github.io/jadepool-hub-tech-docs/zh-hans/

1. 访问下面链接，初始化admin账号,并登录,请务必记清楚设置的密码
> http://IP:3000

2. 进 高级管理->区块链管理->禁用->选择您需要的链，点击启用 

3. 选择您需要开启的链，点击查看详情->区块链配置->节点配置，修改全节点的地址

4. 高级管理->进程管理 中，分别启动您需要的链进程

5. 回到首页，进入default钱包(或者您希望的那个钱包)，钱包设置->应用管理，点击添加应用，填入应用ID/通信公钥/编码方式等

6. 配置回调地址，请将前置应用接收回调消息的地址配入需要接受消息的订单类型中

7. 钱包设置-区块链&代币，开启对应的链

8. 前端应用用来接收瑶池通知的服务，需要配置瑶池的ECC公钥，瑶池的ECC公钥在这里查询：
  高级管理->Jadepool
